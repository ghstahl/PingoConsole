...
namespace ConsoleHostForMef.PingoEmbeddedAssemblies
{
...
/*
        private static void Main(string[] args)
        {
            ...
            AppDomain.CurrentDomain.AssemblyResolve += new ResolveEventHandler(ConsoleHostForMef.PingoEmbeddedAssemblies.AssemblyResolver.OnResolveAssembly);
            MainCore(args);
        }
