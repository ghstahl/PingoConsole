...
namespace PingoConsole.PingoEmbeddedAssemblies
{
...
/*
        private static void Main(string[] args)
        {
            ...
            AppDomain.CurrentDomain.AssemblyResolve += new ResolveEventHandler(PingoConsole.PingoEmbeddedAssemblies.AssemblyResolver.OnResolveAssembly);
            MainCore(args);
        }
